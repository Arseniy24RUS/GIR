...
GitHub Pages публикует онлайн-платформу релиза 2026: страновые профили и основные индексные пространства для всех доступных стран, четыре режима HTEI, международное сравнение, методологию и Data Lab. Серверное обновление источников, административные операции и произвольный исторический пересчёт запускаются через FastAPI локально.
